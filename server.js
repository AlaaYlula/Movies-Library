...
function Trending(id,title,release_date, poster_path,overview){
 ...
 function handleHome(req,res){
        res.status(200).send("Welcome, I am Ala' Alwazani :) You Can Use These Routes /trending , /search?name=thenameofthemovie , /popular , /toprated , /addMovie , /getMovies , /UPDATE/id , /DELETE/id , /getMovie/id ")
